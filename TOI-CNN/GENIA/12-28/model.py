    ...
    def __init__(self, pos_loss_method="smoothL1", lambd=1.0, prevent_over_fitting_method="l2_penalty"):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels=1,
                      ...
                      kernel_size=(kernel_length, word_embedding_dim),  # kernel size
                      stride=1,
                      padding=(int(kernel_length / 2), 0)
                      ),
            nn.ReLU(),
        )
...
# class RCNN_NO_REGRESSOR(nn.Module):   # could set in RCNN loss weight lambda = 0
#     """A RCNN for named entity recognition.
#         Uses an embedding layer, followed by a convolutional, roi pooling layer
...
#             nn.Conv2d(in_channels=1,
#                       out_channels=feature_maps_number,
#                       kernel_size=(kernel_length, word_embedding_dim),
#                       stride=1,
#                       padding=(1, 0)
#                       ),
#             nn.ReLU(),
