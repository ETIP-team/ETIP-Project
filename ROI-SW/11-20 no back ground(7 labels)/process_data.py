...
def process_data_train_k_fold():
    th_iou_train = 0.8
    train_pkl_folder = 'dataset/train/no_bg_train_relabeled_data_pkl_11_16_rb_modify/'
    save_folder = 'dataset/train/no_bg_train_relabeled_data_npz_11_16_rb_modify/'
...
def process_data_test_k_fold():
    train_pkl_folder = 'dataset/test/no_bg_test_relabeled_data_pkl_11_16_rb_modify/'
    save_folder = 'dataset/test/no_bg_test_relabeled_data_npz_11_16_rb_modify/'
    if not os.path.exists(save_folder):
        os.makedirs(save_folder)
    ls_pkl_file_path = [train_pkl_folder + pkl for pkl in os.listdir(train_pkl_folder)]
    for i in range(len(ls_pkl_file_path)):
